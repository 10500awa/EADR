...
\begin{definition}[Color difference function]
	Given two tables $T_1$ and $T_2$ of the same Go game, the difference in a point $t=(t_1,...t_m)$ it's define as,
	\[ 
	\delta(T_1,T_2)_t=
	\begin{cases}
		1 \quad \text{ if }C(t)_{T_1}=C(t)_{T_2}, \\
		0 \quad else. \\
	\end{cases}
	\]
\end{definition}
