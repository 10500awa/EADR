...
\begin{wrapfigure}[11]{l}{0.3\textwidth}
	...
	\end{tikzpicture}
	\caption{Black \textcolor{OliveGreen}{territory}, white \textcolor{Blue}{territory} and \textcolor{Orange}{neutral}.}
	\label{fig:Fig 9}
...
\begin{wrapfigure}[14]{r}{0.33\textwidth}
	...
	\end{tikzpicture}
	\caption{Handicap of the $13\times13$ board.}
	\label{fig:14}
\end{wrapfigure} 
