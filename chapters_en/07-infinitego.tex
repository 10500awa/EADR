...
To begin with, let's see where we are playing now. Our infinite board should be able to have also infinite dimensions and every one of those could be or not infinite as well.
